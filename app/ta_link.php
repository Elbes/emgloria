...
class ta_link extends Model
{
    ...
    public function getTodosLinksInferior(){
    	return DB::table('ta_link')
    	->orderBy('prioridade', 'asc')->whereNull('ta_link.dhs_exclusao_logica')->where('posicao', '=', 'Inferior')
    	->get();
    }
    
    public function getTodosLinksDestaque(){
    	return DB::table('ta_link')
    	->orderBy('prioridade', 'asc')->whereNull('ta_link.dhs_exclusao_logica')->where('posicao', '=', 'Destaque')
    	->get();
    }
