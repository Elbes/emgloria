...
class DevocionalController extends Controller
{
    ...
    public function getListaDevocional()
    {   
    	$usuario = \App\ta_usuarios::where('id_usuario', Auth::user()->id_usuario)->get();
    	
        return view('admin.devocional.listaDevocional', compact('usuario'));
    }
    ...
    public function getInserir()
    {
    	...
    	return view('admin.devocional.inserirDevocional', compact('usuario'));
    }
