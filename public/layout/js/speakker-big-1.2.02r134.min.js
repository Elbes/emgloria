...
jQuery(function (a) {
    ...
    $p.utils = {
        ...
        embeddFlash: function (d, c, k) {
            ...
            e = '<object id="' + c.id + '" codebase="../../https@fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,0,0/#version=9,0,0,0/default.htm"  name="' + c.name + '" width="' + c.width + '" height="' + c.height + '" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"><param name="movie" value="' + c.src + '"></param><param name="allowScriptAccess" value="' + c.allowScriptAccess + '"></param><param name="allowFullScreen" value="' + c.allowFullScreen + '"></param><param name="wmode" value="' + c.wmode + '"></param>';
            ...
            l += ' pluginspage="../../www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash"></embed>';
    ...
    "plugin_share": {
        ...
        "links": {
            ...
            "facebook": {
                ...
                "code": "../../www.facebook.com/crunchpress"
